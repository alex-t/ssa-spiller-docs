...
([[SSA_SPILLER_DESIGN#Register budget: cap by allocatable-file size]]) and (b)
...
([[SSA_RA_Coloring#4.7 Cross-Call Color Constraint]]). This document is the
**priority** next step; it supersedes the deferred precolored-tuple gate for the
ABI/call portion
([[SSA_SPILLER_DESIGN#Precolored-PR tuple-feasibility gate — DOWNSCOPED / DEFERRED (2026-07-15)]]).
