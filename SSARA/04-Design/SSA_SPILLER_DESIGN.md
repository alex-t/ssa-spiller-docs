...
> [Reload_join_phi_coalescing](Reload_join_phi_coalescing.md); the SSA-repair engine is [MachineLaneSSAUpdater](MachineLaneSSAUpdater.md).
...
### Related components
- [MachineLaneSSAUpdater](MachineLaneSSAUpdater.md) — SSA repair (reaching-VNI reconstruction):
...
- [NextUseAnalysis](NextUseAnalysis.md) — Belady next-use distances + lane/subreg ordering:
...
- [Reload_join_phi_coalescing](Reload_join_phi_coalescing.md) — the reload-placement theory this pass implements.
- [GCNUpwardRPTracker_PerClassRP](GCNUpwardRPTracker_PerClassRP.md) · [Spiller_Redesign](Spiller_Redesign.md) — proposed per-class /
...
- Places reloads **on demand**, in dominance order, only where the value is not
  ...
  inline by [MachineLaneSSAUpdater](MachineLaneSSAUpdater.md), which also materializes the merge PHIs.
...
(see [Architecture](Architecture.md#register-files-sgpr-vgpr-agpr)).
...
[SSA_RA_Coloring](SSA_RA_Coloring.md#cross-call-color-constraint)), but they should assert / fall
...
[Reload_join_phi_coalescing](Reload_join_phi_coalescing.md). Summary:
...
[NextUseAnalysis](NextUseAnalysis.md) and the issue note *Static NUA limitation*.
...
([GCNUpwardRPTracker_PerClassRP](GCNUpwardRPTracker_PerClassRP.md), [Spiller_Redesign](Spiller_Redesign.md)) lands.
