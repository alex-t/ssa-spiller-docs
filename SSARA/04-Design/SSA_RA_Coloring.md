...
relieved by coalescing, by the spiller budget cap ([[SSA_SPILLER_DESIGN#Register
budget: cap by allocatable-file size]]), or by narrowing reloads — those reduce
...
> Worklog: [[08-Worklog/2026-07-14-phicoalescer/RELOAD_NARROWING_AND_AGPR_GAP]]
> (evidence + scoping), [[08-Worklog/2026-07-14-phicoalescer/REMAINING_CRASHES_CLASSIFICATION]].
