...
otherwise chase — see [SSA_SPILLER_DESIGN](SSA_SPILLER_DESIGN.md#precolored-pr-tuple-feasibility-gate-downscoped-deferred-2026-07-15).
...
| PHI coalescing — greedy affinity (Option B + sub-reg hints) | ✅ Committed to `ssara` (`3deb087e`); `pickFreePhysReg` consults `collectPhiHints` — see [PHI_Coalescer](PHI_Coalescer.md#101-status-2026-07-14) |
