...
- **Full PHI coalescer:** not implemented. Today: SimplifyUndefPHI + phi-affinity coloring hints +
  PHI-copy metrics (instrumentation). See [PHI Coalescer](../04-Design/PHI_Coalescer.md).
...
- [SSA Rebuilder](../02-Components/SSA_Rebuilder.md) ⚠️ temporary
...
- [SSA Register Allocator](../02-Components/SSA_Register_Allocator_Impl.md) ✅ (coloring + destruction + rewrite)
- [SSA Destruction](../02-Components/SSA_Destruction.md) ✅ (inside the allocator)
