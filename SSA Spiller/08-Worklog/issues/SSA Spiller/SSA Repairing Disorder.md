...
bb1 --> bb3
```
**which is wrong because x was spilled in bb0!**![[shrink spilled LI.png]]



# Fixed:[[Decisions#Design Change Prevent SSA Repair Disorder by Killing Spilled LiveIntervals in Dominated Region|Fix for SSA Repairing failure]]