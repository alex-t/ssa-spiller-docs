...
[[ssara.pdf|Register Allocation for Programs in SSA-Form]]  by Sebastian Hack, Daniel Grund, and Gerhard Goos discusses techniques for *zero-copy SSA deconstruction*.  
...
This mechanism is **debug-only** and does not affect codegen [[SSA_SPILLER_DESIGN#Virtual spill point and SI_VIRTUAL_SPILL_MARKER]].
...
[[Pasted image 20251222213607.png|CFG with PHIs and spill markers]]
