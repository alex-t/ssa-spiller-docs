...
flowchart TD
    ...
    subgraph RegAlloc["SSA Register Allocator 📋 NIY"]
    ...
    style RegAlloc fill:#e2e3e5,stroke:#6c757d,stroke-dasharray: 5 5
...
| Register Allocator | SSA, virtual regs | SSA, physical regs |
