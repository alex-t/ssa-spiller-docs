...
We run Next Use Analysis before the spiller when these new register don't yet exist. As a result, they have no entries in the NUA map and analysis consider these new vregs **dead**, which can immediately select them for spilling again — yielding **no RP relief** and eventually an RP validation failure. [[Static_NUA_limitation]]
...
[[Static_NUA_limitation#Proposed solution]]
...
[[Static_NUA_limitation#Temporary workaround]]
